...
from src.Util import Logger, read_fasta, split_chromosomes, store_fasta, file_exist, map_chr_position, rename_reference
...
if __name__ == '__main__':
    ...
    # rename reference
    ref_rename_path = output_dir + '/genome.rename.fa'
    chr_name_map = output_dir + '/chr_name.map'
